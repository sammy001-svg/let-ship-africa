...
<head>
    ...
    <link rel="icon" type="image/svg+xml" href="<?= e(SITE_URL) ?>/assets/img/favicon.svg">
    <link rel="apple-touch-icon" href="<?= e(SITE_URL) ?>/assets/img/favicon.svg">
...
<nav class="navbar navbar-expand-lg navbar-dark lsa-navbar sticky-top">
    <div class="container">
        <a class="navbar-brand fw-bold d-flex align-items-center gap-2" href="<?= e(SITE_URL) ?>/index.php">
            <i class="bi bi-box-seam-fill text-lsa-accent"></i>
            Let Ship Africa <span class="text-lsa-accent">Inc.</span>
        </a>
