                ...
                <form action="<?= e(SITE_URL) ?>/process/process-intake.php" method="post" data-guard-submit novalidate>
                    ...
                    <div class="lsa-card p-4 p-md-5 mb-4">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="shipper_full_name" name="shipper_full_name" required maxlength="150" value="<?= e($inquiry['full_name'] ?? '') ?>">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label" for="shipper_business_name">Business Name (if applicable)</label>
                                <input type="text" class="form-control" id="shipper_business_name" name="shipper_business_name" maxlength="150" value="<?= e($inquiry['company'] ?? '') ?>">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label" for="shipper_phone">Phone Number *</label>
                                <input type="text" class="form-control" id="shipper_phone" name="shipper_phone" required maxlength="50" value="<?= e($inquiry['phone'] ?? '') ?>">
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="email" class="form-control" id="shipper_email" name="shipper_email" required maxlength="150" value="<?= e($inquiry['email'] ?? '') ?>">
                            </div>
                            <div class="col-md-6">
                    ...
                    <div class="lsa-card p-4 p-md-5 mb-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="customer_signature_name" name="customer_signature_name" required maxlength="150" value="<?= e($inquiry['full_name'] ?? '') ?>">
                        </div>
                    </div>

                    <div class="text-center">
                        <button type="submit" class="btn btn-lsa-accent btn-lg fw-semibold px-5">Submit Intake Form</button>
